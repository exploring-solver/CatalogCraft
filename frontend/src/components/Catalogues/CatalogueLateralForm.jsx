...
const CatalogueLateralForm = ({ catalog }) => {
    ...
    <Card className="w-full max-w-lg mx-auto mt-10">
      ...
      <CardBody className="flex flex-col gap-4">
        ...
        <div className="mb-4">
          ...
          <Typography className="mb-4">{catalog.name}</Typography>
          <Typography variant="h6" className="mb-2">Description</Typography>
          <Typography className="mb-4">{catalog.description}</Typography>
          <Typography variant="h6" className="mb-2">ASIN</Typography>
          <Typography className="mb-4">{catalog.ASIN}</Typography>
          <Typography variant="h6" className="mb-2">UPC</Typography>
          <Typography className="mb-4">{catalog.UPC}</Typography>
          ...
          <Typography className="mb-4">{catalog.about}</Typography>
          <Typography variant="h6" className="mb-2">Category</Typography>
          <Typography className="mb-4">{catalog.category}</Typography>
        </div>
